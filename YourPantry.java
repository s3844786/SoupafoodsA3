...
public class YourPantry {
	...
	public YourPantry() {
		...
		this.Date = new String [this.NumProductCategories];
		...
		try {
			...
			if (filename != null) {
				...
				while (rawInput != null) {
					...
					String date = fieldOfProduct[4];
					
					addProduct(names, grade, weights, prices, date);
					// ----------------------------------------
	...
	public void SearchProductFromEntry() {
		...
		while(i < this.CurrentNumProductCategories) {
			if(this.ProductNames[i].contains(searchTargetName)) {
				String rowData = this.ProductNames[i] + "\t" + this.Grade[i] + "\t" + this.Weight[i] + "\t" + this.Prices[i] + "\t" + this.Date[i];
	...
	public void addProduct(String names, char grade, double weights, double prices, String date) {
...
//			String date = fieldOfProduct[4];
			...
			String message = "";
			if (totalAmount > 20) {
				message = "The best time to use "+ name +" is 8 days.";
			} else {
				message =  "The best time to use "+ name +" is 4 days.";
			}
